...
type
  ...
  ListValidation* = Table[int, ValidationResult]
    ## Items in list that failed validation

  ValidationResult* = object
    ## What issues occured for a validation
  ...
  Validator*[T] = object
    ## Object that performs validation on a value
...
func valid*[T](validator: Validator[T], value: T): bool =
